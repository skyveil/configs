...
static char *font =
    "Iosevka Nerd Font"
    ":style=Medium,Regular:pixelsize=14:antialias=true:autohint=true";
static char *font2[] = {
    "Symbola:pixelsize=12:antialias=true:autohint=true",   // Unicode
    "JetBrains:pixelsize=12:antialias=true:autohint=true", // Powerline
    "Mukta:style=Regular:pixelsize=14",
    "FreeSerif:pixelsize=12:antialias=true:autohint=true", // Devnagari
    "IPAMincho:style=Regular"
};
...
static const char base00[] = "#1e1e1e"; // #272822 #282828
...
static const char base0F[] = "#dfdfdf";
...
static unsigned int defaultcs = 15; // 256;
